  ...
  return (
    <div className="flex pt-16 mx-auto text-offWhite w-3/4">
      <div className="mx-auto w-3/4">
        ...
        <p className="mt-3">Send me an email at laura@505laura.com or message me here:</p>
        ...
        <form className="mt-10">
          ...
          <button type="submit" className="mt-5 rounded-md bg-accent px-10 py-2 text-black">
            Send Message
          </button>
        </form>
      </div>
